...
| B28 | **Projecció paral·lela vs. projecció central** | q91, q92, q104 | *Afegit al tram 13.* El glossari té `projection`, però la distinció entre les dues és el contingut sencer de q92. Emparentada amb B27: són les dues maneres diferents que té una projecció de no ser una dilatació uniforme. |
