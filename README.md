...
**I, des del lot 6 de guies: 68 de les 130 preguntes tenen una GUIA DE DEMOSTRACIÓ.**
...
assets/img/pistes/            — 69 figures de guia (fig-001…fig-069)
css/
...
- **Guies per a les 62 preguntes que encara no en tenen** (68 de 130 fetes)
...
`docs/manifest-figures.tsv` és el registre de les 69 figures: número, pregunta,
